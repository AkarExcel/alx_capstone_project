...
const clickmobile = new Audio("static/sounds/mobile/click.mp3");
const hover = new Audio("static/sounds/hover.mp3");
const hovermobile = new Audio("static/sounds/mobile/hover.mp3");
const hover2 = new Audio("static/sounds/hover2.mp3");
const hover3 = new Audio("static/sounds/hover3.mp3");
const paper = new Audio("static/sounds/paper.mp3");
const papermobile = new Audio("static/sounds/mobile/paper.mp3");
const paperaboutup = new Audio("static/sounds/paperaboutup.mp3");
const paperaboutupmobile = new Audio("static/sounds/mobile/paperaboutup.mp3");
const paperaboutdown = new Audio("static/sounds/paperaboutdown.mp3");
const paperaboutdownmobile = new Audio("static/sounds/mobile/paperaboutdown.mp3");
const skin = new Audio("static/sounds/skin.mp3");
const skinmobile = new Audio("static/sounds/mobile/skin.mp3");
